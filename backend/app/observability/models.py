...
class RequestLog(Base):
    ...
    failover_from_provider: Mapped[str | None] = mapped_column(
        String(100), nullable=True
    )
    failover_to_provider: Mapped[str | None] = mapped_column(
        String(100), nullable=True
    )
    ...
    budget_policy_applied: Mapped[str | None] = mapped_column(
        String(20), nullable=True
    )
    # What the policy did: "blocked" | "warned" | "downgraded" | "none"
    budget_action: Mapped[str | None] = mapped_column(String(20), nullable=True)
    ...
    experiment_version: Mapped[int | None] = mapped_column(Integer, nullable=True)
    experiment_arm: Mapped[str | None] = mapped_column(String(255), nullable=True)
    ...
    guardrails_triggered: Mapped[str | None] = mapped_column(
